...
| DesignerClient | A set of custom activities that contain the `InvokePowerShell` custom activity and other miscellaneous custom activities, and a workflow that uses them. | <ul><li>Activities:<br /><br /> <ul><li><strong>PrintCollection.cs</strong>: A helper activity that prints all the items in a collection to the console.</li><li><strong>ReadLine.cs</strong>: A helper activity for reading input from the console.</li></ul></li><li>File System:<br /><br /> <ul><li><strong>Copy.xaml</strong>: An activity that copies a file.</li><li><strong>CreateFile.xaml</strong>: An activity that creates a file.</li><li><strong>DeleteFile.xaml</strong>: An activity that deletes a file.</li><li><strong>MakeDir.xaml</strong>: An activity that creates a directory.</li><li><strong>Move.xaml</strong>: An activity that moves a file.</li><li><strong>ReadFile.xaml</strong>: An activity that reads a file and returns its contents.</li><li><strong>TestPath.xaml</strong>: An activity that tests for the existence of a path.</li></ul></li><li>Process:<br /><br /> <ul><li><strong>GetProcess.xaml</strong>: An activity that gets a list of running processes.</li><li><strong>StopProcess.xaml</strong>: An activity that stops a specific process.</li></ul></li><li><strong>Program.cs</strong>: Calls the Sequence1 workflow.</li><li><strong>Sequence1.xaml</strong>: A sequence-based workflow.</li></ul> |
